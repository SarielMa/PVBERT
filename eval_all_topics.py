...
# models = [
#     "eppc_bert_base"]
prefix = "/home/lm2445/palmer_scratch/results_071125_class_topics/eppc_model_"
suffix = "/checkpoint-2900"
stamp = "pinfo_topics"
csv_res = []
trainset = "stratified_train_data_topics.json"
testset = "stratified_test_data_topics.json"
...
with open('output_0713.csv', 'w', newline='', encoding='utf-8') as f:
    writer = csv.writer(f)
